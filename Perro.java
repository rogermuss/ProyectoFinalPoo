...
public class Perro extends Tamagotchi implements TamagotchiActions{
    ...
    public Perro(String nombre) {
        super(nombre);
        ImageIcon imagen = buscarIcono("Sources/Perro.png");
        ...
        */
        ...
        ImageIcon imagen3 = buscarIcono("Sources/PerroDormido.png");
        Image img3 = imagen3.getImage().getScaledInstance(300, 400, Image.SCALE_SMOOTH);
